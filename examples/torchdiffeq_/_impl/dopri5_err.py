...
from .misc import (
    ...
    _optimal_step_size, _compute_error_ratio, _select_initial_step_err
)
from .solvers import AdaptiveStepsizeODEErrSolver
...
class Dopri5ErrSolver(AdaptiveStepsizeODEErrSolver):
    ...
    def _adaptive_dopri5_step(self, rk_state):
        ...
        (y1, f1, y1_error, k), tot_dt = _runge_kutta_step(self.func, y0, f0, t0, dt, tableau=_DORMAND_PRINCE_SHAMPINE_TABLEAU)
        ...
        #tot_dt.append(t_next-t0)
        rk_state = _RungeKuttaState(y_next, f_next, t0, t_next, dt_next, interp_coeff)
        return rk_state, tot_dt
